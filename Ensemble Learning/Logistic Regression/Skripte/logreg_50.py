...
ax.set_title(f'Confusion Matrix for Logistic Regression', fontsize=20)
ax.tick_params(axis='x', labelrotation=45, labelsize=10)
ax.tick_params(axis='y', labelrotation=0, labelsize=10)
    
# Save confusion matrix
plt.tight_layout()
plt.savefig("output/log_reg_50_confusion_matrix.png", dpi=300)
plt.close()
...
ax.set_xlabel('Predicted labels', fontsize=15)
ax.set_ylabel('True labels', fontsize=15)
ax.set_title(f'Confusion Matrix for Logistic Regression', fontsize=18)
ax.tick_params(axis='x', labelrotation=90, labelsize=10)
ax.tick_params(axis='y', labelrotation=0, labelsize=10)
    
# Save normalized confusion matrix
plt.tight_layout()
plt.savefig("output/logreg_50_confusion_matrix_normalised.png", dpi=300)
plt.close()
print(f"{datetime.now()}: Confusion matrix for Hard Voter saved.")
...
with open('output/logreg_50_logged_data.json', 'w') as f:
...
excel_path = 'output/logreg_50_predictions_visualization.xlsx'
df.to_excel(excel_path, index=False)
print(f"{datetime.now()}: Results saved to {excel_path}")

# Apply formatting to Excel
wb = load_workbook("output/logreg_50_predictions_visualization.xlsx")
ws = wb.active
true_label_col = 'B'
prediction_cols = ['C', 'D', 'E', 'F']
...
wb.save("output/logreg_50_predictions_visualization_formatted.xlsx")

# Accuracy Calculation and Formatting
wb = load_workbook("output/logreg_50_predictions_visualization_formatted.xlsx")
ws = wb.active
...
wb.save("output/logreg_50_predictions_visualization_with_accuracy.xlsx")
