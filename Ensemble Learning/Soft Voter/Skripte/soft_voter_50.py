...
model_info = {
    'ViTHybrid_50_SD': {
        'path': '/home/student_01/Projects/MA_Cahide/Bilderklassifizierung/Modelle/50/ViTHybrid_50_SD',
    ...
    'ViTHybrid_50_GAN': {
        'path': '/home/student_01/Projects/MA_Cahide/Bilderklassifizierung/Modelle/50/ViTHybrid_50_GAN',
        'processor': ViTHybridImageProcessor.from_pretrained("google/vit-hybrid-base-bit-384"),
        'custom_class': ViTHybridForImageClassification
    },
    ...
    'ViTHybrid_50_all': {
        'path': '/home/student_01/Projects/MA_Cahide/Bilderklassifizierung/Modelle/50/ViTHybrid_50_all',
        'processor': ViTHybridImageProcessor.from_pretrained("google/vit-hybrid-base-bit-384"),
        'custom_class': ViTHybridForImageClassification
    }
...
plt.tight_layout()
plt.savefig("output/soft_voter_50_confusion_matrix.png", dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig("output/soft_voter_50_confusion_matrix_normalised.png", dpi=300)
plt.close()
print(f"{datetime.now()}: Confusion matrix for Hard Voter saved.")
...
with open('output/soft_voter_50_logged_data.json', 'w') as f:
...
excel_path='output/soft_voter_50_predictions_visualization.xlsx'
...
wb = load_workbook("output/soft_voter_50_predictions_visualization.xlsx")
ws = wb.active
...
wb.save("output/soft_voter_50_predictions_visualization_formatted.xlsx")
from openpyxl import load_workbook
from openpyxl.styles import PatternFill
from openpyxl.utils import get_column_letter

# Load your workbook and select the first sheet
wb = load_workbook("output/soft_voter_50_predictions_visualization_formatted.xlsx")
ws = wb.active
...
# Save the workbook
wb.save("output/soft_voter_50_predictions_visualization_with_accuracy.xlsx")
