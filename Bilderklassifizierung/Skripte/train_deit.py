...
# Specify which DeiT model to use
model_name = "facebook/deit-base-distilled-patch16-224"
# model_name = "facebook/deit-base-224"
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/deit_models/"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/min4/DeiT"  # Final model save path
...
for item in dataset["train"]:
  ...
  break
"""
# extract the labels for the dataset
