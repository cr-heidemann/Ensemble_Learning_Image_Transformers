...
dataset = os.path.abspath("/home/student_01/Projects/MA_Cahide/Datasets/50/50_GAN")
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/vithybrid_models/50_GAN"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/50/ViTHybrid_50_GAN"  # Final model save path
