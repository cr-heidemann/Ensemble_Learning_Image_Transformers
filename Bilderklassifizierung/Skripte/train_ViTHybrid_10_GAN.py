...
dataset = os.path.abspath("/home/student_01/Projects/MA_Cahide/Datasets/10/10_GAN")
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/vithybrid_models/10_GAN"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/10/ViTHybrid_10_GAN"  # Final model save path
