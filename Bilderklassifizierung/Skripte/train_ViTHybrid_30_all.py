...
dataset = os.path.abspath("/home/student_01/Projects/MA_Cahide/Datasets/30/30_all")
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/vithybrid_models/30_all"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/30/ViTHybrid_30_all"  # Final model save path
