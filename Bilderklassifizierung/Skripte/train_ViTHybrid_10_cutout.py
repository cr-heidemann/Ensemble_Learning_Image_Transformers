...
dataset = os.path.abspath("/home/student_01/Projects/MA_Cahide/Datasets/10/dataset_10_cutout")
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/vithybrid_models/10_cutout"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/10/ViTHybrid_10_cutout"  # Final model save path
