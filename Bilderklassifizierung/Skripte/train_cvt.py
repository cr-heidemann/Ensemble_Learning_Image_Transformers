...
# Specify which CvT model to use
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/cvt_models/"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/min4/CvT"  # Final model save path
...
for item in dataset["train"]:
  ...
  break
"""
# extract the labels for dataset
