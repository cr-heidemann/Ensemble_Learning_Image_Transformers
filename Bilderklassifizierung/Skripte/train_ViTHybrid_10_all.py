...
dataset = os.path.abspath("/home/student_01/Projects/MA_Cahide/Datasets/10/10_all")
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/vithybrid_models/10_all"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/10/ViTHybrid_10_all"  # Final model save path
