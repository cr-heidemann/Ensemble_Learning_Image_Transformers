...
dataset = os.path.abspath("/home/student_01/Projects/MA_Cahide/Datasets/Base/20_80_10_10_min4")

# Specify which ConvNeXt model to use
...
save_steps = 500
save_total_limit = 2
output_dir = "tmp/convnext_models/"  # Temporary output directory for the best 2 models
final_model_save_path = "Modelle/min4/ConvNeXt/"  # Final model save path
...
from transformers import ConvNextV2ForImageClassification, AutoImageProcessor, ConvNextV2Model
...
training_args = TrainingArguments(
    ...
    #report_to="wandb"  # Report metrics to wandb if wanted
